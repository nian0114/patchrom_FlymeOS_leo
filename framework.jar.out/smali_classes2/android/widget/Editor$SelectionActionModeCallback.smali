...
.method public onDestroyActionMode(Landroid/view/ActionMode;)V
    ...
    :cond_0
    invoke-direct/range {p0 .. p0}, Landroid/widget/Editor$SelectionActionModeCallback;->flymeOnDestroyActionMode()Z
...
.method public onCreateActionModeMz(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    const v7, #android:id@selectAll#t
    ...
    const v5, #android:string@copy#t
    ...
    const v5, #android:string@paste#t
    ...
    invoke-virtual {v4}, Landroid/widget/Editor;->flymeGetFieldTextView()Landroid/widget/TextView;

    move-result-object v4

    invoke-virtual {v4}, Landroid/widget/TextView;->flymeGetIdCopyAll()I

    move-result v4

    sget v5, Lcom/flyme/internal/R$string;->copyAll:I
    ...
    const v3, #android:string@selectAll#t
    ...
    invoke-virtual {v4}, Landroid/widget/TextView;->flymeGetIdStartSelecting()I

    move-result v4

    sget v5, Lcom/flyme/internal/R$string;->select:I
