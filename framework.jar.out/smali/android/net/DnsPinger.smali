...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .local v8, "dnsArg":Landroid/net/DnsPinger$DnsArg;
    ...
    .local v12, "newActivePing":Landroid/net/DnsPinger$ActivePing;
    ...
    .end local v12    # "newActivePing":Landroid/net/DnsPinger$ActivePing;
    ...
    .restart local v12    # "newActivePing":Landroid/net/DnsPinger$ActivePing;
    :catch_1
    move-exception v9
    ...
    const-string v17, "sendDnsPing::Error binding to socket "
    ...
    .end local v7    # "dnsAddress":Ljava/net/InetAddress;
    .end local v8    # "dnsArg":Landroid/net/DnsPinger$DnsArg;
    ...
    .local v6, "curPing":Landroid/net/DnsPinger$ActivePing;
    const/16 v16, 0x2
    ...
    .local v14, "replyPacket":Ljava/net/DatagramPacket;
    ...
    .end local v14    # "replyPacket":Ljava/net/DatagramPacket;
    .end local v15    # "responseBuf":[B
    :catch_2
    move-exception v16
    ...
    .end local v6    # "curPing":Landroid/net/DnsPinger$ActivePing;
    .end local v9    # "e":Ljava/lang/Exception;
    :cond_2
    move-object/from16 v0, p0
    ...
    .local v11, "iter":Ljava/util/Iterator;, "Ljava/util/Iterator<Landroid/net/DnsPinger$ActivePing;>;"
    :cond_3
    :goto_3
    ...
    .restart local v6    # "curPing":Landroid/net/DnsPinger$ActivePing;
    ...
    .end local v11    # "iter":Ljava/util/Iterator;, "Ljava/util/Iterator<Landroid/net/DnsPinger$ActivePing;>;"
    :pswitch_2
    move-object/from16 v0, p0
