...
.method public static asInterface(Landroid/os/IBinder;)Landroid/location/IGeoFenceListener;
    ...
    check-cast v0, Landroid/location/IGeoFenceListener;

    goto :goto_0

    :cond_1
    new-instance v0, Landroid/location/IGeoFenceListener$Stub$Proxy;

    .end local v0    # "iin":Landroid/os/IInterface;
    invoke-direct {v0, p0}, Landroid/location/IGeoFenceListener$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :sswitch_0
    const-string v2, "android.location.IGeoFenceListener"
    ...
    :goto_1
    invoke-virtual {p0, v0}, Landroid/location/IGeoFenceListener$Stub;->geoFenceExpired(Landroid/app/PendingIntent;)V
