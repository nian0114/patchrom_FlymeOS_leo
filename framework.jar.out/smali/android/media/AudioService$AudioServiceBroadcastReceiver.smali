...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$9200(Landroid/media/AudioService;)Z
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$9300(Landroid/media/AudioService;)Z
    ...
    invoke-static {v3, v0, v1, v11}, Landroid/media/AudioService;->access$9500(Landroid/media/AudioService;ZILjava/lang/String;)Z
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$9700(Landroid/media/AudioService;)Landroid/media/AudioService$AudioOrientationEventListener;
    ...
    invoke-static {v3, v0}, Landroid/media/AudioService;->access$9800(Landroid/media/AudioService;Landroid/content/Context;)V
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$9900(Landroid/media/AudioService;)Landroid/media/MediaFocusControl;
    ...
    invoke-static {v3, v4}, Landroid/media/AudioService;->access$10000(Landroid/media/AudioService;Z)V
