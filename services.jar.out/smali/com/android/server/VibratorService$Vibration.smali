...
# instance fields
.field private final mHighPriority:Z
...
.method constructor <init>(Lcom/android/server/VibratorService;Landroid/os/IBinder;JIILjava/lang/String;)V
    ...
    invoke-direct/range {v1 .. v11}, Lcom/android/server/VibratorService$Vibration;-><init>(Lcom/android/server/VibratorService;Landroid/os/IBinder;J[JIIIZLjava/lang/String;)V

    return-void
.end method

.method private constructor <init>(Lcom/android/server/VibratorService;Landroid/os/IBinder;J[JIIIZLjava/lang/String;)V
    .locals 3
    .param p2, "token"    # Landroid/os/IBinder;
    .param p3, "millis"    # J
    .param p5, "pattern"    # [J
    ...
    iput-object p10, p0, Lcom/android/server/VibratorService$Vibration;->mOpPkg:Ljava/lang/String;

    iput-boolean p9, p0, Lcom/android/server/VibratorService$Vibration;->mHighPriority:Z

    return-void
.end method

.method synthetic constructor <init>(Lcom/android/server/VibratorService;Landroid/os/IBinder;J[JIIIZLjava/lang/String;Lcom/android/server/VibratorService$1;)V
    .locals 1
    ...
    .param p11, "x9"    # Lcom/android/server/VibratorService$1;

    .prologue
    invoke-direct/range {p0 .. p10}, Lcom/android/server/VibratorService$Vibration;-><init>(Lcom/android/server/VibratorService;Landroid/os/IBinder;J[JIIIZLjava/lang/String;)V
...
.method static synthetic access$1400(Lcom/android/server/VibratorService$Vibration;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/VibratorService$Vibration;

    .prologue
    iget-boolean v0, p0, Lcom/android/server/VibratorService$Vibration;->mHighPriority:Z
...
.method static synthetic access$800(Lcom/android/server/VibratorService$Vibration;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/VibratorService$Vibration;
