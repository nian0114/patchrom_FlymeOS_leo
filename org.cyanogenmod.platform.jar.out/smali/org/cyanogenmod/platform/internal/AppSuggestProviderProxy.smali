...
.method public static createAndBind(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;III)Lorg/cyanogenmod/platform/internal/AppSuggestProviderProxy;
    ...
    .line 48
    .end local v0    # "proxy":Lorg/cyanogenmod/platform/internal/AppSuggestProviderProxy;
    :goto_0
    return-object v0

    .restart local v0    # "proxy":Lorg/cyanogenmod/platform/internal/AppSuggestProviderProxy;
    :cond_0
    const/4 v0, 0x0
...
.method public getSuggestions(Landroid/content/Intent;)Ljava/util/List;
    ...
    .line 90
    .local v1, "service":Lcyanogenmod/app/suggest/IAppSuggestProvider;
    if-nez v1, :cond_0
    ...
    :cond_0
    :try_start_0
    invoke-interface {v1, p1}, Lcyanogenmod/app/suggest/IAppSuggestProvider;->getSuggestions(Landroid/content/Intent;)Ljava/util/List;
    :try_end_0
    ...
    sget-object v2, Lorg/cyanogenmod/platform/internal/AppSuggestProviderProxy;->TAG:Ljava/lang/String;
    ...
    iget-object v4, p0, Lorg/cyanogenmod/platform/internal/AppSuggestProviderProxy;->mServiceWatcher:Lcom/android/server/ServiceWatcher;
...
.method public handles(Landroid/content/Intent;)Z
    ...
    :cond_0
    :try_start_0
    invoke-interface {v1, p1}, Lcyanogenmod/app/suggest/IAppSuggestProvider;->handles(Landroid/content/Intent;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_1
